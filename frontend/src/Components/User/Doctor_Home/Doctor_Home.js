        ...
        <div className="container" data-aos="zoom-in">
          <div className="row">
            ...
            <div class="col-md-12 d-flex justify-content-center">
              <NavLink to="/Doctor_Page">
                <button class="btn btn-primary mx-auto">View More<i class="bx bx-chevron-right"></i>
                </button>
              </NavLink>
            </div>

          </div>
          {/* <NavLink to="#">View More<i class="bx bx-chevron-right"></i></NavLink> */}
